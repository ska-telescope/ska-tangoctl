...
from ska_tangoctl.tango_control.check_tango_device import set_tango_admin  # type: ignore
from ska_tangoctl.tango_control.check_tango_device import show_obs_state  # type: ignore
